...
export class Planemodel extends Model {
    ...
    //         -1,
    //         -1
    //     )) === null || (this._vbos[VBOType.Texture] = Model.bindBufferObject(
    //         this._vbos[VBOType.Texture],
    //         gl.ARRAY_BUFFER,
    //         this._datas[VBOType.Texture], 
    //         tsize,  
    //         VBOType.Texture,
    //         3,
    //         gl.STATIC_DRAW
    //     )) === null || (this._vbos[VBOType.Normal] = Model.bindBufferObject(
    //         this._vbos[VBOType.Normal],
    //         gl.ARRAY_BUFFER,
    //         this._datas[VBOType.Normal], 
    //         nsize,  
    //         VBOType.Normal,
    //         3,
    //         gl.DYNAMIC_DRAW‌
    //     )) === null || (this._vbos[VBOType.Flag] = Model.bindBufferObject(
    //         this._vbos[VBOType.Flag],
    //         gl.ARRAY_BUFFER,
    //         this._datas[VBOType.Flag], 
    //         fsize,  
    //         VBOType.Flag,
    //         3,
    //         gl.STATIC_DRAW
    ...
    //             if (!this.hasTexture) continue; // 没有贴图则跳过绑定
    //             gl.bindTexture(gl.TEXTURE_2D, this.textures[i]);
    //             // 设置纹理边界颜色（WebGL 2.0+ 支持）
    //             // 归一化为 0-1
    //             const borderColor = new Float32Array([1.0, 1.0, 1.0, 1.0]); 
    ...
    //                 gl.TEXTURE_2D,
    //                 0,
    //                 planeModelBuildData.textureAttribute.gammaCorrection ? gl.SRGB : gl.RGB,
    //                 planeModelBuildData.textureAttribute.width,
    //                 planeModelBuildData.textureAttribute.height,
    //                 0,
    //                 gl.RGB,
    //                 gl.UNSIGNED_BYTE,
    //                 planeModelBuildData.imageDatas[i]
    //             );
